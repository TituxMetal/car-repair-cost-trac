...
import { CaretDownIcon, CaretUpIcon, CheckCircleIcon, ClockIcon } from '@phosphor-icons/react'
              ...
              {dueThisWeek.map(event => (
                <div
                  ...
                  className={`flex items-center justify-between p-2 rounded-md border ${
                    isOverdue(event) ? 'border-red-500/50 bg-red-500/10' : 'border-border'
                  }`}
                >
                  ...
                  <Button
                    ...
                    className='h-11 px-3 shrink-0 transition-all duration-150'
